...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>
          Bachelor of Science in Computer Science and Engineering | Southeast
          University
        </li>
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>REST APIs</li> <li>VS Code</li> <li>Git </li>
        <li>Figma</li> <li>Netlify</li> <li>Vercel</li> <li>Render</li>
        <li>Postman</li> <li>Stripe</li> <li>JWT</li>
        <li>Ubuntu Os</li>
        <li>Windows OS</li>
      </ul>
    ),
